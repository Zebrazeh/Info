...
Share++ überträgt Fotos, Dateien und Links vom iPhone an ein beliebiges anderes Gerät in der Nähe (auch Android) per QR-Code, ohne dass der Empfänger eine App installieren oder ein Konto anlegen muss.

**3. Welche Daten werden verarbeitet?**

Die von dir zum Teilen ausgewählte Datei (Foto, Dokument oder Link) wird für die Dauer der Übergabe – typischerweise wenige Minuten – über Apples CloudKit-Dienst zwischengespeichert. Share++ betreibt keinen eigenen Server; einziger Verarbeiter im Auftrag ist Apple.
...
Apple (Apple Distribution International, Irland, bzw. Apple Inc., USA) fungiert als Auftragsverarbeiter im Rahmen des Apple Developer Program License Agreement. Share++ betreibt keine eigene Serverinfrastruktur und protokolliert keine Inhalte.

**5. Empfängerseite**

Die Person, die den QR-Code scannt, benötigt keine Apple-ID, kein Konto und keine App. Share++ verarbeitet keinerlei Daten dieser Empfänger:innen – keine IP-Adressen, kein Tracking, keine Analyse. Zugriffs-Logs auf Apples Auslieferungs-Infrastruktur liegen allein in Apples Verantwortung als Auftragsverarbeiter.
...
Share++ verlangt keine Registrierung und kein Login. Es sind keine Drittanbieter-SDKs, keine Werbe- oder Analyse-Dienste enthalten.

**9. Speicherdauer**

Geteilte Inhalte werden spätestens bei Beendigung der Freigabe bzw. nach Ablauf der Anzeigezeit gelöscht. Es gibt keine darüber hinausgehende Speicherung durch Share++.

**10. Deine Rechte (DSGVO)**

Du hast das Recht auf Auskunft, Berichtigung, Löschung und Einschränkung der Verarbeitung sowie auf Datenübertragbarkeit. Da Share++ keine dauerhaften personenbezogenen Daten speichert, sind diese Rechte in der Praxis vor allem durch die eingebaute Sofortlöschung abgedeckt. Du hast zudem das Recht auf Beschwerde bei einer Datenschutzaufsichtsbehörde.
...
Privacy Policy – Share++ (English)
As of: July 2026

**Controller:** Daniel Menzel, daniel@zebrazeh.de, https://zebrazeh.de

**What Share++ does:** Share++ transfers photos, files, and links from your iPhone to any nearby device (including Android) via a QR code, without the recipient needing to install an app or create an account.
...
**Recipient side:** The person scanning the QR code needs no Apple ID, no account, and no app. Share++ processes no data about recipients whatsoever — no IP addresses, no tracking, no analytics. Access logs on Apple's delivery infrastructure are Apple's own responsibility as processor.
...
**Retention:** Shared content is deleted at the latest when the share ends or the on-screen timer runs out. Share++ retains nothing beyond that.

**Your rights (GDPR):** You have the right to access, rectification, erasure, and restriction of processing, as well as data portability. Since Share++ does not persistently store personal data, these rights are in practice covered by the built-in immediate deletion. You also have the right to lodge a complaint with a data protection supervisory authority.
...
**Ce que fait Share++ :** Share++ transfère des photos, fichiers et liens depuis votre iPhone vers n'importe quel appareil à proximité (y compris Android) via un code QR, sans que le destinataire ait besoin d'installer une application ou de créer un compte.
...
**Côté destinataire :** La personne qui scanne le code QR n'a besoin ni d'identifiant Apple, ni de compte, ni d'application. Share++ ne traite aucune donnée relative aux destinataires — ni adresse IP, ni suivi, ni analyse. Les journaux d'accès sur l'infrastructure de diffusion d'Apple relèvent de la seule responsabilité d'Apple en tant que sous-traitant.
...
**Durée de conservation :** Le contenu partagé est supprimé au plus tard à la fin du partage ou à l'expiration du minuteur à l'écran. Share++ ne conserve rien au-delà.

**Vos droits (RGPD) :** Vous disposez du droit d'accès, de rectification, d'effacement et de limitation du traitement, ainsi que du droit à la portabilité des données. Share++ ne stockant pas durablement de données personnelles, ces droits sont en pratique couverts par la suppression immédiate intégrée. Vous avez également le droit d'introduire une réclamation auprès d'une autorité de contrôle.
...
**Qué hace Share++:** Share++ transfiere fotos, archivos y enlaces desde tu iPhone a cualquier dispositivo cercano (incluido Android) mediante un código QR, sin que el destinatario necesite instalar una aplicación ni crear una cuenta.
